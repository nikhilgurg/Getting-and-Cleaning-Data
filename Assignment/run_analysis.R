...
#Unzip the file
unzip(zipfile="./Dataset.zip",exdir="./Assignment/data")
#unzipped files are in the folder UCI HAR Dataset. Get the list of the files
path_rf <- file.path("./Assignment/data" , "UCI HAR Dataset")
...
write.table(Data2, file = "./Assignment/tidy_dataset.txt",row.name=FALSE)
